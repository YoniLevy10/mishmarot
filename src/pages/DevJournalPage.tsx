    ...
    <div className="space-y-3">
      <Card>
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className="text-lg font-extrabold text-slate-900 dark:text-white">יומן מפתח</div>
          ...
          <Link className="text-sm font-semibold text-blue-700 hover:text-blue-800 dark:text-indigo-200 dark:hover:text-white" to="/">
            חזרה
          </Link>
        </div>
      </Card>
      ...
      <Card>
        <div className="text-sm font-extrabold text-slate-900 dark:text-white">איפה אנחנו עומדים</div>
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-slate-700 dark:text-slate-200/90">
      ...
      <Card>
        <div className="text-sm font-extrabold text-slate-900 dark:text-white">מה כבר בוצע (בפועל)</div>
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-slate-700 dark:text-slate-200/90">
          ...
          <li>מסך Login: אימייל/סיסמה + Google OAuth + מצב בהיר/כהה.</li>
          <li>סיכום: Hero + גרף חודשים + ייצוא Excel + שיתוף משמרת.</li>
        </ul>
      </Card>

      <Card>
        <div className="text-sm font-extrabold text-slate-900 dark:text-white">מה חסר / מה לבדוק</div>
        <ul className="mt-2 list-inside list-disc space-y-1 text-sm text-slate-700 dark:text-slate-200/90">
      ...
      <Card>
        <div className="text-sm font-extrabold text-slate-900 dark:text-white">תכנון קדימה (צעדים הגיוניים הבאים)</div>
        <ol className="mt-2 list-inside list-decimal space-y-1 text-sm text-slate-700 dark:text-slate-200/90">
